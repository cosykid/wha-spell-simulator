 ...
 * mark from `palette.ts`, so four stamps carry the entire pigment ramp. Each one
 * meets a lumpy organic mask before it lands, so no stamp ever carries energy to
 * its quad border and the mass can never show a rectangle.
 */
