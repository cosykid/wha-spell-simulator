 ...
 * state, so a seek and a live run sample the identical field.
 */
 ...
 * instead of spraying. Forward differences without the divide, matching the
 * GPU version's magnitudes so one turbulence gain means one thing.
 */
