...
import { FLOW, SIM_SIZE, STEP_S } from './tuning.js';
import { burnAt, driveAt, emberDriftAt, emissionAt, strikeAt, type FluidSpell } from './spell.js';
...
export class FluidSim {
	...
	constructor(renderer: THREE.WebGLRenderer, spell: FluidSpell) {
	...
	step(tMs: number) {
		...
		this.#uniforms.uMotes.value = emberDriftAt(this.#spell, tMs) * 0.035;
		this.#uniforms.uStrike.value = strikeAt(this.#spell, tMs);
