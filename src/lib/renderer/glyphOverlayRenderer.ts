...
function drawSingleStroke(ctx: CanvasRenderingContext2D, stroke: Stroke, options: StrokeDrawOptions = {}): void {
...
export function drawRingDebug(ctx: CanvasRenderingContext2D, ring: RingInfo | null | undefined): void {
  if (!ring?.found) {
    return;
  }
...
export function drawStrokeIdDebug(ctx: CanvasRenderingContext2D, strokes: Stroke[] | null | undefined): void {
  ctx.save();
