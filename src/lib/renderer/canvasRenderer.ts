...
export class CanvasRenderer {
  ...
  renderGlyph({ strokes, currentStroke, pipeline, showGuides, showDebug }: GlyphRenderParams): void {
  ...
  renderActivatedGlyph({ activatedAt, duration, strokes, pipeline, timestamp }: ActivatedGlyphRenderParams): void {
