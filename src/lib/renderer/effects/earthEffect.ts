...
function earthFlowConfig(spellIR: RenderSpellIR, ring: RingInfo, portal: Portal, frame: number): EarthFlowConfig {
...
function spawnEarthParticle(_spellIR: RenderSpellIR, portal: Portal, flow: EarthFlowConfig): Particle {
