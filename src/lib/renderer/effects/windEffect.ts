...
function windFlowConfig(spellIR: RenderSpellIR, ring: RingInfo, portal: Portal, frame: number): WindFlowConfig {
...
function spawnWindParticle(spellIR: RenderSpellIR, portal: Portal, flow: WindFlowConfig): WindParticle {
