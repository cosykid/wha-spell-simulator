...
function fireFlowConfig(spellIR: RenderSpellIR, ring: RingInfo, portal: Portal, frame: number): FireFlowConfig {
...
function spawnSuspendedFireParticle(spellIR: RenderSpellIR, ring: RingInfo, portal: Portal, flow: FireFlowConfig, frame: number): FireParticle {
  const scale = effectScale(spellIR);
...
function spawnFlowFireParticle(spellIR: RenderSpellIR, ring: RingInfo, portal: Portal, flow: FireFlowConfig): FireParticle {
  const scale = effectScale(spellIR);
  const focus = effectFocus(spellIR);
...
function spawnFireParticle(spellIR: RenderSpellIR, ring: RingInfo, portal: Portal, flow: FireFlowConfig, frame: number): FireParticle {
...
function updateSuspendedFireParticle(particle: FireParticle, flow: FireFlowConfig, dt: number): void {
  particle.age += dt;
