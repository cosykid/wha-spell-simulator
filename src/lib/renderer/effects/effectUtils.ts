...
export function steadyParticleAlpha(particle: Particle, spellIR: RenderSpellIR, fadeInFrames: number = 10): number {
...
export function convergenceFlow(spellIR: RenderSpellIR, portal: Portal, frame: number): ConvergenceFlow {
...
export function convergePoint(point: Vector, convergence: ConvergenceFlow, phase: number = 0, radiusScale: number = 1): Vector {
...
export function scaledParticleCount(baseCount: number, spellIR: RenderSpellIR, config: AppConfig): number {
...
export function randomPortalPoint(portal: Portal, radiusXScale: number = 1, radiusYScale: number = radiusXScale): Vector {
