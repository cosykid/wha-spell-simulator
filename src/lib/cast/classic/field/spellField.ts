// SpellField — typed force operators compiled from the seal reading.
//
...
// z out of the paper. The classic engine builds one field per spell; its field
// effect superposes the sources at each particle position every frame.
//
// Restored from `src/lib/types/spell-field.ts` at `b439a01`. It lives here
// rather than in `types/` because it no longer crosses a seam: nothing outside
// this engine has a field.
