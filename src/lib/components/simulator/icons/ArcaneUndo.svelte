<!--
@component
Arcane undo glyph: a counter-clockwise rotation arrow. Sourced from game-icons.net (Delapouite, CC BY 3.0;
see icons/CREDITS.md). Filled glyph, so it inherits the plate's icon styling
(currentColor fill). See CanvasIconButton.
-->
<script lang="ts">
