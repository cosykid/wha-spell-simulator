...
import type { SpellDirection, Vector } from "../types.js";

const MAX_COMPONENT_TILT_DEG = 82;
const FORCE_TILT_MAX_DEG = 76;
const MIN_SURFACE_DIRECTION_MAGNITUDE = 0.001;

export function directionFromTiltAngles(xTiltDeg = 0, yTiltDeg = 0): SpellDirection {
...
export function directionFromSurfaceVector(surfaceDirection: Vector, force: number): SpellDirection {
