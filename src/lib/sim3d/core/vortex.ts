/**
 * @file The twist channels' vortex structure (GROUND_TRUTH §7 canon check —
...
import { smoothstep, type Vec3 } from './math2.js';
...
/** Solid-body spin rate of the funnel wall — the renderer's whirl phase rate. */
 ...
 * U_PULL·PULL_TWIST_GAIN); the geometry below is shared. γ keeps its sign on
 * the tangential term (turn sense); the secondary cell reads |γ|.
 */
export function addVortex(
	...
	// sheath around a calmer eye, which is also where the renderer skins it
	{
