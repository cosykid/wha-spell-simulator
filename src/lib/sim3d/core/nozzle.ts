...
import { angDist, angleOf, dot, len, norm, scale, sigmoid, sub, v2, type Vec2 } from './math2.js';
import { ELEMENT_GRIP, type SimSeal } from './model.js';
...
export function compileSeal(seal: SimSeal): Nozzle {
	let S = 0;
	let P = v2(0, 0);
	let C = 0;
	let gamma = 0;
