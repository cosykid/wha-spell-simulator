...
- Sounds the cast on the same clock: a charge that swells through the portal tilt, a strike, and a body synthesized from a voice table keyed on the sigil (fire crackles, water bubbles, wind whistles, earth rumbles, light and crystal ring). No audio files, and one mute button (or `M`) beside the effect style.
